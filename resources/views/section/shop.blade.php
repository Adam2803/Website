...
<div id="default-carousel" class="relative w-full mt-28" data-carousel="slide">
    <!-- Carousel wrapper -->
    <div class="relative h-auto overflow-hidden rounded-lg md:h-2/4">
         <!-- Item 1 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ asset('build\assets\images\sda.png') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
        </div>
        <!-- Item 2 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
...
<!---------------------------->
  <section class="relative flex items-center justify-center   mt-2 overflow-hidden text-black font-sans text-4xl font-bold mb-56">
